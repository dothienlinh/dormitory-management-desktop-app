...
export namespace resty {
	...
	export class Request {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.RawPathParams = source["RawPathParams"];
	        this.Header = source["Header"];
	        this.Time = this.convertValues(source["Time"], null);
	        this.Body = source["Body"];
	        this.Result = source["Result"];
	        this.Error = source["Error"];
	        this.RawRequest = this.convertValues(source["RawRequest"], http.Request);
	        this.SRV = this.convertValues(source["SRV"], SRVRecord);
	        this.UserInfo = this.convertValues(source["UserInfo"], User);
	...
	export class Response {
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.Request = this.convertValues(source["Request"], Request);
	        this.RawResponse = this.convertValues(source["RawResponse"], http.Response);
	    }
